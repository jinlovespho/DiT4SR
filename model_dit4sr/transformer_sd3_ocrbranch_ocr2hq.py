...
from .attention_ocrbranch_ocr2hq import JointTransformerBlock

logger = logging.get_logger(__name__)  # pylint: disable=invalid-name

class SD3Transformer2DModel_OCRBranch_OCR2HQ(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin):
    """
