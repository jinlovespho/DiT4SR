...
from .attention_ocrbranch_ocr2hq2ocr import JointTransformerBlock

logger = logging.get_logger(__name__)  # pylint: disable=invalid-name

class SD3Transformer2DModel_OCRBranch_OCR2HQ2OCR(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin):
    """
    ...
    def forward(
        ...
        height, width = hidden_states.shape[-2:]    # 64 64, vae encoder hq latent (b 16 64 64)
        ...
        ## control_dit begin
        controlnet_image_latent = self.pos_embed(controlnet_image) # b 16 64 64 -> apply patch and pos emb -> b 1024 1536
        ## make another ocrbranch
        ocr_image_latent = self.pos_embed(controlnet_image) # b 16 64 64 -> apply patch and pos emb -> b 1024 1536
        hidden_states = torch.cat([hidden_states, controlnet_image_latent, ocr_image_latent], dim=-2)    # concat in token dimension -> b 1024+1024+1024 1536 -> b 3072 1536
        ## control_dit end
        ...
        extract_feat_idx = cfg.train.transformer.feat_extract_layer   # extract all 24 layer s
