...
#     --pretrained_model_name_or_path preset/models/stable-diffusion-3.5-medium \
#     --transformer_model_name_or_path train_result/dit4sr/TRAIN_server12_gpu0_satext_dit4sr_lr5e-6_bs2_gradaccum4_llava13bprompt/checkpoint-10000 \
#     --image_path /media/dataset2/text_restoration/SAMText_test_degradation/lv3 \
#     --satext_ann_path /media/dataset2/text_restoration/100K/test/dataset.json \
#     --output_dir results/satext/lv3/tair_dit4sr_llavaprompt_all_ckpt10000 \
#     --use_precomputed_prompts results/satext/lv3/dit4sr_q_llavaprompt/txt \
#     --save_prompts \
#     --captioner llava \
...
CUDA_VISIBLE_DEVICES=7 python test/test_wllava.py \
    --pretrained_model_name_or_path preset/models/stable-diffusion-3.5-medium \
    --transformer_model_name_or_path train_result/dit4sr_stage2/TRAIN_STAGE2_server12_gpu1_satext_dit4sr_lr5e-6_testr_lr1e-4_bs2_gradaccum4_llava13bprompt/checkpoint-6000 \
    --image_path /media/dataset2/text_restoration/SAMText_test_degradation/lv3 \
    --satext_ann_path /media/dataset2/text_restoration/100K/test/dataset.json \
    --output_dir results/satext/lv3/dit4sr_stage2_llavaprompt_all_ckpt6000 \
    --use_precomputed_prompts results/satext/lv3/dit4sr_q_llavaprompt/txt \
    --save_prompts \
    --captioner llava \